...
function AllImagesThumbnails(props) {
    ...
    if (props.thumbnails === undefined) {
      pageElement = <div className="all-image-tns"></div>
    } else {
      if (props.next) {
        nextButton = <></>
      } else {
      ...
      if(props.prev) {
        ...
        prevButton = (
          <button aria-label="previous-image" className="up-button" onClick={props.cycle} name="Prev">
            <img
            alt="up-arrow-previous-image"
            name="Prev"
            onClick={props.cycle}
            className="up-img"
            src={UpArrow}></img>
